...
## Config Settings
To get the dataset, you can run ```get_data.py```, this  uses only the CPU and takes about 3 hours to run on a laptop, but before runing the program here are some config you can change:
```
config = {
    'data_name':'1976-2016',
