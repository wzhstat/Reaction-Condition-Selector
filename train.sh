...
chemprop_train --data_path ./data/GCN_solv_reag0_withN/GCN_data.csv --dataset_type multiclass --multiclass_num_classes 4570 --save_dir ./data/GCN_reag0_withN  --reaction --extra_metrics accuracy top3 --epochs 20
chemprop_train --data_path ./data/GCN_solv_reag0_withoutN/GCN_data.csv --dataset_type multiclass --multiclass_num_classes 4569 --save_dir ./data/GCN_reag0_withoutN  --reaction --extra_metrics accuracy top3 --epochs 20
